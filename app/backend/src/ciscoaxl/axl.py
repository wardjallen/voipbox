...
class axl(object):
    ...
    def get_phone(self, **args):
        ...
        try:
            return self.client.getPhone(**args, returnedTags=tagfilter)["return"]["phone"]
        except Fault as e:
            return e
    ...
    def add_phone(
        ...
        device_pool="Default",
        location="Hub_None",
        phone_template="Standard 8841 SIP",
        common_device_config="",
        css="",
        aar_css="",
        subscribe_css="",
        ...
        [('77777', 'LINE_PT', 'Jim Smith', 'Jim Smith',
                ...
                req["lines"]["line"].append(
                    {
                        ...
                        "label": i[4],
                        "e164Mask": i[5],
                        "associatedEndusers": {"enduser": [{"userId": i[6]}]}
                    }
                )
                for i in lines
            ]
    ...
    def add_remote_destination_profile(
        ...
        css="",
        lines=[],
        dev_class="Remote Destination Profile",
        protocol="Remote Destination",
        owner_username="",
        network_hold_moh_audio_source="",
        user_hold_moh_audio_source="",
        calling_info_privacy_status="Default",
    ):
        req = {
            "name": name,
            "description": description,
            ...
            "protocolSide": "User",
            "devicePoolName": device_pool,
            "networkHoldHohAudioSourceId": network_hold_moh_audio_source,
            "userHoldHohAudioSourceId": user_hold_moh_audio_source,
            "callingSearchSpaceName": css,
            "lines": {"line": []},
            "callInfoPrivacyStatus": calling_info_privacy_status,
        ...
        try:
            return self.client.addRemoteDestinationProfile(req)
        except Fault as e:
            return e
        ...
        try:
            return self.client.updateUser(
                ...
                primaryExtension={
                    ...
                    "routePartitionName": primaryExtPartition,
                },
                phoneProfiles=phoneProfiles,
                ctiControlledDeviceProfiles=phoneProfiles,
            )
        except Fault as e:
            return e
